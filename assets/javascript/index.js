...
$("#submit").on("click", function (event) {
  ...
  var jobsURL = "https://authenticjobs.com/api/?api_key=950957111a9b72525093584bfdef9610&method=aj.jobs.search&keywords=" + jobInput +"&format=json" 
  ...
  $.ajax({
    ...
    $("#jobsDiv").text(JSON.stringify(response));
    console.log(response)
